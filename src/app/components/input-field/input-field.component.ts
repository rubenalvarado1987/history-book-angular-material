...
@Component({
  ...
  styles: [`
    ...
    .input-container.has-error .input-underline {
      height: 2px;
      background: #dc2626;
    }
    ...
    .input-container.focused .input-icon-left {
      color: #3b82f6;
    }
    
    .input-container.has-error .input-icon-left {
      color: #dc2626;
    ...
    .input-container.focused .input-icon-right {
      color: #3b82f6;
    }
    
    .input-container.has-error .input-icon-right {
      color: #dc2626;
    }
    ...
    .input-wrapper.has-error .input-helper {
      color: #dc2626;
    }
